...
@ComponentScans(value = { @ComponentScan("it.academy.by.spring.dao"),
    @ComponentScan("it.academy.by.spring.service") })
public class AppConfig {
  ...
  public LocalSessionFactoryBean getSessionFactory() {
    ...
    factoryBean.setPackagesToScan("it.academy.by.spring.model.entity");
    
  //  factoryBean.setAnnotatedClasses(User.class, Authorities.class, NewsEntity.class);
